/**
 * Abroad Veda CRM — database layer
 * All reads/writes go through these helpers so the UI never calls Supabase directly.
 * Tables: students, team_members, notes, applications, documents
 */
  ...
  const { data, error } = await supabase
    ...
    .select(`
      *,
      ...
      applications ( id, course, institution, commence_date, status ),
